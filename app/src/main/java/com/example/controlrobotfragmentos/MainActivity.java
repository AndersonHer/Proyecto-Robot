...
public class MainActivity extends AppCompatActivity {
    ...
    private void programa()
    {
        ...
        tablayout.getTabAt(0).setIcon(R.drawable.verticaltabs);
        tablayout.getTabAt(1).setIcon(R.drawable.horizontaltabs);
        tablayout.getTabAt(2).setIcon(R.drawable.voztabs);
    }
}
